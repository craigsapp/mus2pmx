...
## Syntax:        GNU Makefile
##
## Description: This Makefile creates the mus2pmx program for multiple
##              operating systems.  Also, gives basic guidelines on how 
##              to compile for Windows using MinGW in linux.
##
